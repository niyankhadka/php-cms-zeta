				...
				<div class="col-lg-6">
					...
					<?php 
                        ...
                        if(isset($_GET['category'])){
                            ...
                            $cat_rows = mysqli_fetch_assoc($select_category);
						...
						<h1>Category : <strong style='color:#ff4200;'><?php echo $cat_title; ?></strong></h1>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="blog_main_content">
						...
						<?php
                $query = "SELECT * FROM posts WHERE post_category_id = $category_id HAVING post_status = 1";
                $select_posts_query = mysqli_query($connection , $query);
                $check_rows = mysqli_num_rows($select_posts_query);
            if($check_rows > 0){
                while($posts_rows = mysqli_fetch_assoc($select_posts_query)){
                ...
                ?>
						...
						<article class="blog_post">
							...
							<div class="blog_post_meta">
                                ...
                                ?>
								<span class="blog_post_category"><?php echo $cat_title; ?></span>
                ...
                echo "<h2 class=''>No post found related to <strong style='color:#ff4200;'>{$cat_title}</strong> category.</h2>";
            }
                        ?>
